...
;	index -> Y+0
	...
	LD   R30,Y
	LDD  R31,Y+1
	LDI  R26,LOW(_MAX_VALUES*2)
	LDI  R27,HIGH(_MAX_VALUES*2)
	LSL  R30
	ROL  R31
	ADD  R30,R26
	ADC  R31,R27
...
; 0000 0067         sprintf(buffer_2, "%02d:%02d:00", hour, min);
	LDI  R30,LOW(_buffer_2)
	LDI  R31,HIGH(_buffer_2)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,15
	ST   -Y,R31
